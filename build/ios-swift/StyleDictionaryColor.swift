...
public enum StyleDictionaryColor {
    ...
    public static let basePrimary = hsl(UIColor(red: 0.133, green: 0.133, blue: 0.467, alpha: 1),68,50)
    public static let baseRed = UIColor(red: 1.000, green: 0.000, blue: 0.000, alpha: 1)
    public static let coreBaseBrand = UIColor(red: 0.133, green: 0.133, blue: 0.467, alpha: 1)
